...
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider */ "./source/js/modules/slider.js");
/* harmony import */ var _modules_startActionTimer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/startActionTimer */ "./source/js/modules/startActionTimer.js");
/* harmony import */ var _modules_showTabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showTabs */ "./source/js/modules/showTabs.js");
...
/* harmony import */ var _modules_caclulate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/caclulate */ "./source/js/modules/caclulate.js");
/* harmony import */ var _modules_service_fetFetch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/service/fetFetch */ "./source/js/modules/service/fetFetch.js");
/* harmony import */ var _modules_CreateMenuClass__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/CreateMenuClass */ "./source/js/modules/CreateMenuClass.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/form */ "./source/js/modules/form.js");
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_modules_showTabs__WEBPACK_IMPORTED_MODULE_5__.showTabs)('.tabheader__items', '.tabheader__item');
  (0,_modules_startActionTimer__WEBPACK_IMPORTED_MODULE_4__.startActionTimer)('2021-04-12', 'days', 'hours', 'minutes', 'seconds');
  var timerModal = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_6__.showModalElement)('.modal', timerModal);
  }, 5000);
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_6__.modal)('.modal', '.modal__close', '.js-modal', timerModal);
  (0,_modules_caclulate__WEBPACK_IMPORTED_MODULE_7__.calculate)();
  (0,_modules_service_fetFetch__WEBPACK_IMPORTED_MODULE_8__.getFetch)('http://localhost:3000/menu').then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price;
      new _modules_CreateMenuClass__WEBPACK_IMPORTED_MODULE_9__.CreateMenuItem(img, altimg, title, descr, price, '.menu__field .container').render();
    });
  });
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_10__.default)('form');
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_3__.slider)({
    controlSelector: '.offer__slider-counter',
    slElemsSelector: '.offer__slide',
    totalValueSelector: '#total',
    curentValueSelector: '#current',
    slWrapperSelector: '.offer__slider'
...
/***/ "./source/js/modules/CreateMenuClass.js":
/*!**********************************************!*\
  !*** ./source/js/modules/CreateMenuClass.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CreateMenuItem = /*#__PURE__*/function () {
  function CreateMenuItem(src, alt, title, description, prise, parentNode) {
    var transferCource = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 27;

    _classCallCheck(this, CreateMenuItem);
  ...
  _createClass(CreateMenuItem, [{
    ...
    value: function render() {
      ...
      classes.forEach(function (item) {
        return div.classList.add(item);
      });
      div.innerHTML = "\n        <img src=".concat(src, " alt=").concat(alt, " />\n        <h3 class=\"menu__item-subtitle\">").concat(title, "</h3>\n        <div class=\"menu__item-descr\">").concat(description, "</div>\n        <div class=\"menu__item-divider\"></div>\n        <div class=\"menu__item-price\">\n          <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n          <div class=\"menu__item-total\"><span>").concat(prise, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n        </div>");
      parentNode.prepend(div);
    }
  }]);
...
/***/ "./source/js/modules/caclulate.js":
/*!****************************************!*\
  !*** ./source/js/modules/caclulate.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function calculate() {
  ...
  function calculateCall(resultsElementCSS) {
    var result = document.querySelector(resultsElementCSS);
  ...
  function getInputValue(inputsElementsCSS, targetElementCSS) {
    var calculateInputs = document.querySelector(inputsElementsCSS);
    calculateInputs.addEventListener('input', function (event) {
  ...
  function getStaticValue(parentElementCSS, elementsValueCSS, targetElementCSS, changeActiveClass) {
    var parenElement = document.querySelector(parentElementCSS);
    var elementWithValue = parenElement.querySelectorAll(elementsValueCSS);
    parenElement.addEventListener('click', function (event) {
      var target = event.target;
      if (!target.matches(targetElementCSS)) return;
      elementWithValue.forEach(function (elem) {
        return elem.classList.remove(changeActiveClass);
      });
...
/* harmony import */ var _service_postFetch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./service/postFetch */ "./source/js/modules/service/postFetch.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal */ "./source/js/modules/modal.js");
...
var forms = function forms(formsSelector) {
  var forms = document.querySelectorAll(formsSelector);
  forms.forEach(function (item) {
    return sendFormsData(item);
  });
  var serviseMessage = {
    loading: ['Запрос обрабатывается', '../img/spinner.svg'],
    load: 'Данные успешно отправлены. Мы вам перезвоник в течение 30 минут',
  ...
  function sendFormsData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_service_postFetch__WEBPACK_IMPORTED_MODULE_8__.default)('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
        showMessageModal(data, form, serviseMessage.load);
      })["catch"](function () {
        showErrorModalMessage(form, serviseMessage.error);
  ...
  function showErrorModalMessage(form, message) {
    var modalDialog = document.querySelector('.modal .modal__dialog');
    var modalMessage = document.querySelector('.modal__content');
    var messageModal = document.createElement('div');
    messageModal.classList.add('modal__content');
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showModalElement)('.modal');
    modalMessage.style.display = "none";
    messageModal.innerHTML = "<div class=\"modal__title\">".concat(message, "</div>");
    modalDialog.append(messageModal);
    var timerReq = setTimeout(function () {
      messageModal.remove();
      form.reset();
      modalMessage.style.display = "";
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.closModalElement)('.modal');
  ...
  function showMessageModal(data, form, message) {
    ...
    if (data === null) {
      messageModal.innerHTML = "<div class=\"modal__title\">".concat(message[0], "</div><img src = ").concat(message[1], " width=\"38px\" height=\"38px\">");
      return;
    }
...
/* harmony export */   "closModalElement": () => (/* binding */ closModalElement),
/* harmony export */   "showModalElementScroll": () => (/* binding */ showModalElementScroll),
...
function showModalElement(classModalParentElememntCSS, timerModal) {
  var modalWrapper = document.querySelector(classModalParentElememntCSS);
  if (modalWrapper.classList.contains('show')) return;
  modalWrapper.classList.toggle('show');
  document.body.style.overflow = 'hidden';
...
function closModalElement(classModalParentElememntCSS) {
  var modalWrapper = document.querySelector(classModalParentElememntCSS);
  if (!modalWrapper.classList.contains('show')) return;
  modalWrapper.classList.toggle('show');
  document.body.style.overflow = '';
...
function modal(classModalParentElememntCSS, classModalClosElement, classModalOpenElement, timerModal) {
  var modalWrapper = document.querySelector(classModalParentElememntCSS);
  var modalClose = document.querySelector(classModalClosElement);
  var modalOpen = document.querySelectorAll(classModalOpenElement);
  ...
  modalOpen.forEach(function (item) {
    item.addEventListener('click', function () {
      return showModalElement(classModalParentElememntCSS, timerModal);
    });
  });
}
...
/***/ "./source/js/modules/service/addActiveClass.js":
/*!*****************************************************!*\
  !*** ./source/js/modules/service/addActiveClass.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var addActiveClass = function addActiveClass(elementSelectorCSS, activeClass, index) {
  ...
  var tabElements = document.querySelectorAll(elementSelectorCSS);
...
/***/ "./source/js/modules/service/fetFetch.js":
/*!***********************************************!*\
  !*** ./source/js/modules/service/fetFetch.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("\u041F\u0440\u0438 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0438 \u0412\u0430\u0448\u0435\u0433\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u043F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430. \u0421\u0442\u0430\u0442\u0443\u0442\u0443\u0441 \u043E\u0448\u0438\u0431\u043A\u0438: ".concat(response.status, ", URL \u043E\u0448\u0438\u0431\u043A\u0438: ").concat(url));
...
/***/ "./source/js/modules/service/postFetch.js":
/*!************************************************!*\
  !*** ./source/js/modules/service/postFetch.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function postFetch(_x, _x2) {
  return _postFetch.apply(this, arguments);
}

function _postFetch() {
  _postFetch = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (postFetch);

/***/ }),

/***/ "./source/js/modules/service/showContent.js":
/*!**************************************************!*\
  !*** ./source/js/modules/service/showContent.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var showContent = function showContent(elementSelectorCSS, addClass, index) {
  var tabContents = document.querySelectorAll(elementSelectorCSS);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "showTabs": () => (/* binding */ showTabs)
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _service_showContent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./service/showContent */ "./source/js/modules/service/showContent.js");
/* harmony import */ var _service_addActiveClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./service/addActiveClass */ "./source/js/modules/service/addActiveClass.js");





var showTabs = function showTabs(elementSelectorCSS, tabsElemCSS) {
  var tabs = document.querySelector(elementSelectorCSS);
  var tabElements = document.querySelectorAll(tabsElemCSS);
  (0,_service_showContent__WEBPACK_IMPORTED_MODULE_2__.showContent)('.tabcontent', 'show', 0);
  (0,_service_addActiveClass__WEBPACK_IMPORTED_MODULE_3__.addActiveClass)('.tabheader__item', 'tabheader__item_active', 0);
  tabs.addEventListener('click', function (event) {
    var target = event.target;
    if (!target.matches('.tabheader__item')) return;
    tabElements.forEach(function (item, index) {
      if (target != item) return;
      (0,_service_showContent__WEBPACK_IMPORTED_MODULE_2__.showContent)('.tabcontent', 'show', index);
      (0,_service_addActiveClass__WEBPACK_IMPORTED_MODULE_3__.addActiveClass)('.tabheader__item', 'tabheader__item_active', index);
    });
  });
...
var slider = function slider(_ref) {
  var controlSelector = _ref.controlSelector,
      slElemsSelector = _ref.slElemsSelector,
      totalValueSelector = _ref.totalValueSelector,
      curentValueSelector = _ref.curentValueSelector,
      slWrapperSelector = _ref.slWrapperSelector;
  var slider = document.querySelector(slWrapperSelector);
  var sliderControl = document.querySelector(controlSelector); // parent node sliders control elements

  var sliderElements = document.querySelectorAll(slElemsSelector); // elements of slider

  var sliderTotalCauntElement = document.querySelector(totalValueSelector);
  sliderTotalCauntElement.innerHTML = sliderElements.length > 10 ? sliderElements.length : "0".concat(sliderElements.length);
  var sliderCurentElem = document.querySelector(curentValueSelector);
  ...
  sliderControl.addEventListener('click', function (event) {
    var sliderCurent = +sliderCurentElem.innerHTML;
    var sliderTotal = +sliderTotalCauntElement.innerHTML;
    ...
    sliderCurent = sliderCurent > 10 ? sliderCurent : "0".concat(sliderCurent);
    sliderCurentElem.innerHTML = sliderCurent;
  });

  function createDotSlider(parentNode, count) {
    var dotContainer = document.createElement('ol');
    dotContainer.style.cssText = "position: absolute;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        z-index: 15;\n        display: flex;\n        justify-content: center;\n        margin-right: 15%;\n        margin-left: 15%;\n        list-style: none;";
  ...
  function showActiveDot(index) {
    var dots = document.querySelectorAll('.offer__slider ol li');
...
/***/ "./source/js/modules/startActionTimer.js":
/*!***********************************************!*\
  !*** ./source/js/modules/startActionTimer.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "startActionTimer": () => (/* binding */ startActionTimer)
/* harmony export */ });
...
function startActionTimer(dedline, daysIDCSS, hoursIDCSS, minutesIDCSS, secondsIDCSS) {
  setActionDate(dedline, daysIDCSS, hoursIDCSS, minutesIDCSS, secondsIDCSS);
  var intervalID = setInterval(function () {
    return setActionDate(dedline, daysIDCSS, hoursIDCSS, minutesIDCSS, secondsIDCSS);
  }, 1000);
  ...
  function setActionDate(endtime, daysID, hoursID, minutesID, secondsID) {
    var _getArrayElementsByID = getArrayElementsByID(daysID, hoursID, minutesID, secondsID),
        _getArrayElementsByID2 = _slicedToArray(_getArrayElementsByID, 4),
        day = _getArrayElementsByID2[0],
        hour = _getArrayElementsByID2[1],
        minute = _getArrayElementsByID2[2],
        second = _getArrayElementsByID2[3];

    var _getActionTime = getActionTime(endtime),
        totalSeconds = _getActionTime.totalSeconds,
        days = _getActionTime.days,
        hours = _getActionTime.hours,
        minutes = _getActionTime.minutes,
        seconds = _getActionTime.seconds;

    if (totalSeconds == 0) return null;
    day.innerHTML = "".concat(days);
    hour.innerHTML = "".concat(hours);
    minute.innerHTML = "".concat(minutes);
    second.innerHTML = "".concat(seconds);
  }

  function getArrayElementsByID() {
  ...
  function getActionTime(endtime) {
    ...
    // }
    var totalSeconds = Math.floor((new Date(endtime) - new Date()) / 1000);
    var days = convertTime(Math.floor(totalSeconds / (3600 * 24)));
    var hours = convertTime(Math.floor(totalSeconds / 3600 % 24));
    var minutes = convertTime(Math.floor(totalSeconds / 60 % 60));
    var seconds = convertTime(Math.floor(totalSeconds % 60));
    return {
  ...
  function convertTime(time) {
    return time >= 10 ? "".concat(time) : "0".concat(time);
  }
}
